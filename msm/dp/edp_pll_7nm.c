...
static int edp_pll_enable_7nm(struct dp_pll *pll)
{
	...
	dp_pll_write(dp_ln_tx0, TXn_RES_CODE_LANE_OFFSET_TX0, 0x11);
	dp_pll_write(dp_ln_tx0, TXn_RES_CODE_LANE_OFFSET_TX1, 0x11);
	dp_pll_write(dp_ln_tx1, TXn_RES_CODE_LANE_OFFSET_TX0, 0x11);
	dp_pll_write(dp_ln_tx1, TXn_RES_CODE_LANE_OFFSET_TX1, 0x11);
