...
static unsigned long dp_vco_recalc_rate_3nm(struct dp_pll *pll)
{
...
static unsigned long dp_pll_link_clk_recalc_rate(struct clk_hw *hw, unsigned long parent_rate)
{
	...
	return mult_frac(pll->vco_rate, pll->clk_factor, 10);
}
					  ...
					  struct clk_rate_request *req)
{
	...
	req->rate = mult_frac(pll->vco_rate, pll->clk_factor, 10);
